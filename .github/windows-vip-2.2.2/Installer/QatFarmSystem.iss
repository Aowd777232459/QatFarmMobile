...
OutputBaseFilename=QatFarmSystem_Setup_2.2.2_x64
...
Filename: "{cmd}"; Parameters: "/C netsh advfirewall firewall delete rule name=""AWAD SOFT QatFarm WiFi Sync"" >nul 2>&1 & netsh advfirewall firewall add rule name=""AWAD SOFT QatFarm WiFi Sync"" dir=in action=allow program=""{app}\{#MyAppExeName}"" protocol=TCP localport=5276 profile=private"; Flags: runhidden waituntilterminated
...
[UninstallRun]
Filename: "{cmd}"; Parameters: "/C netsh advfirewall firewall delete rule name=""AWAD SOFT QatFarm WiFi Sync"""; Flags: runhidden waituntilterminated
...
var
  ConfigDir, ConfigPath, JsonText, ServerName: String;
begin
